...
class Correos
{
	...
	private function config(){
		...
		$this->mail->Host       = "mail.griant.mx"; // SMTP server
		$this->mail->Username   = "desarrollo@griant.mx"; // SMTP account username
		$this->mail->Password   = "AGrijalva123";     // SMTP account password		
		$this->mail->setFrom('desarrollo@griant.mx', 'Asesoria');
